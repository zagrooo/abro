...
(function (A) {
  ...
  /* ═══════════════════════════════════════════════
     چیدمان ایزومتریک هر پرده

     نما از بالاست و هر پرده نقشه‌ی ثابت خودش را دارد: از یک چرخ
     دستی روی سه کاشی تا یک هلدینگ روی صد و شصت کاشی.

     مختصات کاشی است نه پیکسل. spot یعنی یک بخشِ قابل لمس:
       id  شناسه‌ی ایستگاه (همان STATIONS)
       x,y گوشه‌ی کاشی
       w,h اندازه بر حسب کاشی
       h3  بلندی حجم (۰ یعنی تخت، مثل فرش یا صف)

     هر پرده فقط بخش‌هایی را دارد که تا آن پرده باز شده‌اند — بقیه
     به‌صورت «زمینِ خالیِ آماده» دیده می‌شوند تا بازیکن بفهمد جا
     برای رشد هست.
     ═══════════════════════════════════════════════ */
  var LAYOUTS = [
    /* ۱ — چرخ پدر */
    {
      w: 5, h: 5, floor: 'asphalt', door: { x: 2, y: 4 },
      spots: [
        { id: 'stove', x: 1, y: 1, w: 1, h: 1, h3: 39 },
        { id: 'counter', x: 2, y: 2, w: 2, h: 1, h3: 27 }
      ],
      decor: [{ k: 'lamp', x: 4, y: 0 }, { k: 'crate', x: 0, y: 3 }]
    },
    /* ۲ — دکه‌ی سرِ کوچه */
    {
      w: 6, h: 6, floor: 'asphalt', door: { x: 2, y: 5 },
      spots: [
        { id: 'stove', x: 1, y: 1, w: 2, h: 1, h3: 39 },
        { id: 'counter', x: 3, y: 2, w: 2, h: 1, h3: 27 },
        { id: 'peyk', x: 0, y: 4, w: 2, h: 1, h3: 30 }
      ],
      decor: [{ k: 'lamp', x: 5, y: 0 }, { k: 'plant', x: 5, y: 4 }, { k: 'crate', x: 0, y: 0 }]
    },
    /* ۳ — مغازه */
    {
      w: 7, h: 7, floor: 'tile', door: { x: 3, y: 6 },
      spots: [
        { id: 'stove', x: 1, y: 1, w: 2, h: 1, h3: 42 },
        { id: 'counter', x: 3, y: 3, w: 3, h: 1, h3: 27 },
        { id: 'peyk', x: 0, y: 5, w: 2, h: 1, h3: 30 },
        { id: 'kitchen', x: 4, y: 1, w: 2, h: 2, h3: 45 }
      ],
      decor: [{ k: 'lamp', x: 6, y: 0 }, { k: 'plant', x: 0, y: 3 }, { k: 'bench', x: 5, y: 5 }]
    },
    /* ۴ — رستوران کوچک */
    {
      w: 8, h: 7, floor: 'tile', door: { x: 3, y: 6 },
      spots: [
        { id: 'stove', x: 1, y: 1, w: 2, h: 1, h3: 42 },
        { id: 'counter', x: 3, y: 3, w: 3, h: 1, h3: 27 },
        { id: 'peyk', x: 0, y: 5, w: 2, h: 1, h3: 30 },
        { id: 'kitchen', x: 4, y: 1, w: 2, h: 2, h3: 45 },
        { id: 'brand', x: 6, y: 4, w: 2, h: 1, h3: 69 }
      ],
      decor: [{ k: 'lamp', x: 7, y: 0 }, { k: 'plant', x: 0, y: 3 },
      { k: 'bench', x: 5, y: 5 }, { k: 'table', x: 2, y: 4 }]
    },
    /* ۵ — رستوران */
    {
      w: 9, h: 8, floor: 'wood', door: { x: 4, y: 7 },
      spots: [
        { id: 'stove', x: 1, y: 1, w: 2, h: 1, h3: 42 },
        { id: 'counter', x: 3, y: 4, w: 3, h: 1, h3: 27 },
        { id: 'peyk', x: 0, y: 6, w: 2, h: 1, h3: 30 },
        { id: 'kitchen', x: 4, y: 1, w: 2, h: 2, h3: 45 },
        { id: 'brand', x: 7, y: 5, w: 2, h: 1, h3: 69 },
        { id: 'storage', x: 6, y: 1, w: 2, h: 2, h3: 51 }
      ],
      decor: [{ k: 'lamp', x: 8, y: 0 }, { k: 'plant', x: 0, y: 4 },
      { k: 'table', x: 2, y: 5 }, { k: 'table', x: 5, y: 6 }]
    },
    /* ۶ — چند شعبه */
    {
      w: 10, h: 9, floor: 'wood', door: { x: 4, y: 8 },
      spots: [
        { id: 'stove', x: 1, y: 1, w: 2, h: 1, h3: 42 },
        { id: 'counter', x: 3, y: 4, w: 3, h: 1, h3: 27 },
        { id: 'peyk', x: 0, y: 7, w: 2, h: 1, h3: 30 },
        { id: 'kitchen', x: 4, y: 1, w: 2, h: 2, h3: 45 },
        { id: 'brand', x: 8, y: 6, w: 2, h: 1, h3: 69 },
        { id: 'storage', x: 7, y: 1, w: 2, h: 2, h3: 51 },
        { id: 'packing', x: 6, y: 4, w: 3, h: 2, h3: 39 }
      ],
      decor: [{ k: 'lamp', x: 9, y: 0 }, { k: 'plant', x: 0, y: 4 },
      { k: 'table', x: 2, y: 6 }, { k: 'table', x: 4, y: 6 }]
    },
    /* ۷ — کارخانه‌ی کوچک */
    {
      w: 11, h: 9, floor: 'concrete', door: { x: 5, y: 8 },
      spots: [
        { id: 'stove', x: 1, y: 1, w: 2, h: 1, h3: 42 },
        { id: 'counter', x: 3, y: 4, w: 3, h: 1, h3: 27 },
        { id: 'peyk', x: 0, y: 7, w: 2, h: 1, h3: 30 },
        { id: 'kitchen', x: 4, y: 1, w: 2, h: 2, h3: 45 },
        { id: 'brand', x: 9, y: 6, w: 2, h: 1, h3: 69 },
        { id: 'storage', x: 7, y: 1, w: 2, h: 2, h3: 51 },
        { id: 'packing', x: 6, y: 4, w: 3, h: 2, h3: 39 },
        { id: 'fleet', x: 0, y: 3, w: 2, h: 2, h3: 36 }
      ],
      decor: [{ k: 'lamp', x: 10, y: 0 }, { k: 'crate', x: 10, y: 3 }, { k: 'table', x: 3, y: 6 }]
    },
    /* ۸ — شرکت */
    {
      w: 12, h: 10, floor: 'concrete', door: { x: 5, y: 9 },
      spots: [
        { id: 'stove', x: 1, y: 1, w: 2, h: 1, h3: 42 },
        { id: 'counter', x: 3, y: 5, w: 3, h: 1, h3: 27 },
        { id: 'peyk', x: 0, y: 8, w: 2, h: 1, h3: 30 },
        { id: 'kitchen', x: 4, y: 1, w: 2, h: 2, h3: 45 },
        { id: 'brand', x: 10, y: 7, w: 2, h: 1, h3: 69 },
        { id: 'storage', x: 7, y: 1, w: 2, h: 2, h3: 51 },
        { id: 'packing', x: 6, y: 4, w: 3, h: 2, h3: 39 },
        { id: 'fleet', x: 0, y: 3, w: 2, h: 2, h3: 36 },
        { id: 'catering', x: 9, y: 3, w: 3, h: 2, h3: 45 }
      ],
      decor: [{ k: 'lamp', x: 11, y: 0 }, { k: 'plant', x: 0, y: 6 }, { k: 'table', x: 4, y: 7 }]
    },
    /* ۹ — برند شهری */
    {
      w: 13, h: 10, floor: 'marble', door: { x: 6, y: 9 },
      spots: [
        { id: 'stove', x: 1, y: 1, w: 2, h: 1, h3: 42 },
        { id: 'counter', x: 3, y: 5, w: 3, h: 1, h3: 27 },
        { id: 'peyk', x: 0, y: 8, w: 2, h: 1, h3: 30 },
        { id: 'kitchen', x: 4, y: 1, w: 2, h: 2, h3: 45 },
        { id: 'brand', x: 11, y: 7, w: 2, h: 1, h3: 69 },
        { id: 'storage', x: 7, y: 1, w: 2, h: 2, h3: 51 },
        { id: 'packing', x: 6, y: 4, w: 3, h: 2, h3: 39 },
        { id: 'fleet', x: 0, y: 3, w: 2, h: 2, h3: 36 },
        { id: 'catering', x: 10, y: 3, w: 3, h: 2, h3: 45 },
        { id: 'academy', x: 10, y: 0, w: 3, h: 2, h3: 57 }
      ],
      decor: [{ k: 'plant', x: 0, y: 6 }, { k: 'table', x: 4, y: 7 }, { k: 'lamp', x: 9, y: 9 }]
    },
    /* ۱۰ — زنجیره */
    {
      w: 14, h: 11, floor: 'marble', door: { x: 6, y: 10 },
      spots: [
        { id: 'stove', x: 1, y: 1, w: 2, h: 1, h3: 42 },
        { id: 'counter', x: 3, y: 5, w: 3, h: 1, h3: 27 },
        { id: 'peyk', x: 0, y: 8, w: 2, h: 1, h3: 30 },
        { id: 'kitchen', x: 4, y: 1, w: 2, h: 2, h3: 45 },
        { id: 'brand', x: 12, y: 8, w: 2, h: 1, h3: 69 },
        { id: 'storage', x: 7, y: 1, w: 2, h: 2, h3: 51 },
        { id: 'packing', x: 6, y: 4, w: 3, h: 2, h3: 39 },
        { id: 'fleet', x: 0, y: 3, w: 2, h: 2, h3: 36 },
        { id: 'catering', x: 10, y: 4, w: 3, h: 2, h3: 45 },
        { id: 'academy', x: 10, y: 0, w: 3, h: 2, h3: 57 },
        { id: 'franchise', x: 3, y: 8, w: 3, h: 2, h3: 48 }
      ],
      decor: [{ k: 'plant', x: 0, y: 6 }, { k: 'lamp', x: 13, y: 0 }, { k: 'table', x: 8, y: 8 }]
    },
    /* ۱۱ — گروه */
    {
      w: 15, h: 12, floor: 'marble', door: { x: 7, y: 11 },
      spots: [
        { id: 'stove', x: 1, y: 1, w: 2, h: 1, h3: 42 },
        { id: 'counter', x: 3, y: 5, w: 3, h: 1, h3: 27 },
        { id: 'peyk', x: 0, y: 9, w: 2, h: 1, h3: 30 },
        { id: 'kitchen', x: 4, y: 1, w: 2, h: 2, h3: 45 },
        { id: 'brand', x: 13, y: 9, w: 2, h: 1, h3: 69 },
        { id: 'storage', x: 7, y: 1, w: 2, h: 2, h3: 51 },
        { id: 'packing', x: 6, y: 4, w: 3, h: 2, h3: 39 },
        { id: 'fleet', x: 0, y: 3, w: 2, h: 2, h3: 36 },
        { id: 'catering', x: 10, y: 4, w: 3, h: 2, h3: 45 },
        { id: 'academy', x: 10, y: 0, w: 3, h: 2, h3: 57 },
        { id: 'franchise', x: 3, y: 8, w: 3, h: 2, h3: 48 },
        { id: 'office', x: 12, y: 6, w: 3, h: 2, h3: 78 }
      ],
      decor: [{ k: 'plant', x: 0, y: 6 }, { k: 'lamp', x: 14, y: 0 }, { k: 'table', x: 8, y: 9 }]
    },
    /* ۱۲ — هلدینگ */
    {
      w: 16, h: 13, floor: 'marble', door: { x: 7, y: 12 },
      spots: [
        { id: 'stove', x: 1, y: 1, w: 2, h: 2, h3: 42 },
        { id: 'counter', x: 3, y: 6, w: 4, h: 1, h3: 27 },
        { id: 'peyk', x: 0, y: 10, w: 2, h: 1, h3: 30 },
        { id: 'kitchen', x: 4, y: 1, w: 3, h: 2, h3: 45 },
        { id: 'brand', x: 14, y: 10, w: 2, h: 1, h3: 69 },
        { id: 'storage', x: 8, y: 1, w: 2, h: 2, h3: 51 },
        { id: 'packing', x: 6, y: 4, w: 4, h: 2, h3: 39 },
        { id: 'fleet', x: 0, y: 3, w: 2, h: 3, h3: 36 },
        { id: 'catering', x: 11, y: 4, w: 3, h: 2, h3: 45 },
        { id: 'academy', x: 11, y: 0, w: 3, h: 2, h3: 57 },
        { id: 'franchise', x: 3, y: 9, w: 3, h: 2, h3: 48 },
        { id: 'office', x: 13, y: 6, w: 3, h: 3, h3: 78 }
      ],
      decor: [{ k: 'plant', x: 0, y: 7 }, { k: 'lamp', x: 15, y: 0 },
      { k: 'table', x: 9, y: 9 }, { k: 'plant', x: 15, y: 12 }]
    }
  ];

  /* رنگ کف هر جنس */
  var FLOORS = {
    asphalt: { a: '#39424f', b: '#2f3742', line: 'rgba(160,185,220,.16)' },
    tile: { a: '#46505f', b: '#3a4350', line: 'rgba(190,210,240,.20)' },
    wood: { a: '#5c452f', b: '#4c3826', line: 'rgba(230,190,140,.18)' },
    concrete: { a: '#434852', b: '#383d46', line: 'rgba(190,200,215,.16)' },
    marble: { a: '#4e5870', b: '#414a5f', line: 'rgba(210,225,250,.22)' }
  };
  ...
  /* ═══════════════════════════════════════════════
     ...
     هر ایستگاه از چند تکه‌ی واقعی ساخته شده. سطح ایستگاه بین همین
     تکه‌ها پخش می‌شود، یعنی جمع سطح زیرقطعه‌ها همیشه برابر سطح
     ایستگاه است. عمداً نه نرخ تازه‌ای می‌آورند و نه جای تازه‌ای
     می‌خورند — این‌جا فقط چهره‌ی رشد است، نه اقتصادِ تازه. جای
     ضریب اختصاصی هر تکه بعداً روی همین اسکلت باز می‌شود.

     تکه‌ی بعدی سرِ چه سطحی باز می‌شود، از همین نردبان می‌آید:
     تکه‌ی اول از همان اول هست، بقیه فاصله‌شان کم‌کم بیشتر می‌شود. */
  var SUB_GATES = [0, 1, 3, 6, 10, 15, 21, 28, 36, 45, 55, 66];

  var SUB_RAW = {
    stove: [['pot', 'دیگ'], ['flame', 'شعله'], ['hood', 'هود'], ['board', 'تخته'],
      ['knife', 'چاقو'], ['fridge', 'یخچال'], ['skewer', 'سیخ'], ['spice', 'ادویه‌دان']],
    counter: [['till', 'صندوق'], ['scale', 'ترازو'], ['case', 'ویترین'], ['tray', 'سینی'],
      ['cups', 'لیوان'], ['price', 'تابلوی قیمت'], ['napkin', 'جادستمالی']],
    peyk: [['bike', 'موتور'], ['hotbox', 'جعبه‌ی گرم'], ['helmet', 'کلاه'],
      ['bag', 'کیسه'], ['map', 'نقشه'], ['radio', 'بی‌سیم']],
    kitchen: [['bench', 'میز کار'], ['oven', 'فر'], ['fryer', 'سرخ‌کن'], ['sink', 'ظرف‌شویی'],
      ['shelf', 'قفسه'], ['hood', 'هودِ بزرگ'], ['chiller', 'یخچال صنعتی'], ['rack', 'آبچکان']],
    brand: [['board', 'تابلو'], ['neon', 'نئون'], ['speaker', 'بلندگو'], ['flyer', 'بروشور'],
      ['color', 'رنگ اختصاصی'], ['photo', 'عکاس'], ['page', 'صفحه‌ی مجازی']],
    storage: [['shelf', 'قفسه'], ['cold', 'سردخانه'], ['scale', 'ترازوی باری'],
      ['sheet', 'برگه‌ی موجودی'], ['pallet', 'پالت'], ['door', 'درِ عقب'], ['temp', 'دماسنج']],
    packing: [['belt', 'نوار نقاله'], ['sealer', 'دستگاه دوخت'], ['label', 'برچسب‌زن'],
      ['boxer', 'جعبه‌ساز'], ['scale', 'ترازوی خودکار'], ['wrap', 'فیلم‌کش'], ['check', 'بازرسی چشمی']],
    fleet: [['van', 'وانت'], ['gps', 'ردیاب'], ['fuel', 'پمپ سوخت'], ['garage', 'تعمیرگاه'],
      ['rest', 'اتاق راننده'], ['chill', 'یخچال ماشین'], ['paper', 'بارنامه']],
    catering: [['pot', 'دیگ بزرگ'], ['table', 'میز پذیرایی'], ['silver', 'ظرف نقره'],
      ['tent', 'چادر'], ['gen', 'ژنراتور'], ['bus', 'سرویس کارکنان'], ['list', 'دفتر مجالس']],
    academy: [['class', 'کلاس'], ['train', 'آشپزخانه‌ی تمرین'], ['board', 'تخته'],
      ['note', 'جزوه'], ['cert', 'گواهی'], ['cam', 'دوربین ضبط'], ['exam', 'آزمون']],
    franchise: [['deal', 'قرارداد'], ['manual', 'دفترچه‌ی استاندارد'], ['auditor', 'بازرس شعبه'],
      ['sign', 'تابلوی یکسان'], ['train', 'آموزش شعبه'], ['mark', 'حق نشان'], ['map', 'نقشه‌ی شهر']],
    office: [['meet', 'اتاق جلسه'], ['acc', 'حسابداری'], ['legal', 'حقوقی'], ['server', 'سرور'],
      ['archive', 'بایگانی'], ['tea', 'آبدارخانه'], ['plate', 'تابلوی هلدینگ'], ['ceo', 'اتاق مدیرعامل']]
  };

  /* نردبان را همین‌جا روی تکه‌ها می‌نشانیم تا جدول بالا فقط اسم باشد */
  var SUBPARTS = {};
  Object.keys(SUB_RAW).forEach(function (sid) {
    SUBPARTS[sid] = SUB_RAW[sid].map(function (p, i) {
      return { id: p[0], name: p[1], at: SUB_GATES[i] };
    });
  });
  ...
  /* ═══════════════════════════════════════════════
     ...
     ═══════════════════════════════════════════════ */
  /* هر شهر همان دوازده پرده است با یک قید متفاوت.
     rule فقط ضریب است، نه قانون تازه — تا هیچ‌وقت شهری «قفل» نشود:
       sell       ضریب فروش
       wage       ضریب دستمزد
       tierCost   ضریب هزینه‌ی بالا رفتن پرده
       space      جای اضافه یا کم
       rival      رقیب از چه نقطه‌ای شروع می‌کند (۰ تا ۱)
       fine       ضریب جریمه‌ی بازرسی

     شهر اول عمداً خنثی است: هم برای بازیکن تازه، هم برای اینکه
     شبیه‌ساز همیشه همان‌جا بماند و نگهبان بالانس نلرزد. */
  var CITIES = [
    {
      name: 'کوچه‌ی قدیم', climate: 'mild', tint: null, note: 'همان‌جا که شروع شد.',
      rule: {}, ruleNote: 'بدون قید. همان بازیِ همیشگی.'
    },
    {
      name: 'بندر', climate: 'north', tint: '#1a3040', note: 'بوی نم و ماهی.',
      rule: { sell: 1.10, wage: 1.30 },
      ruleNote: 'مشتری زیاد است، ولی کارگر بندری گران است.'
    },
    {
      name: 'کویر', climate: 'desert', tint: '#2e2418', note: 'شب‌ها سرد، روزها بی‌رحم.',
      rule: { sell: 0.92, space: 3 },
      ruleNote: 'زمین ارزان و باز، ولی مشتری کم.'
    },
    {
      name: 'کوهستان', climate: 'mountain', tint: '#1c2634', note: 'هوا رقیق است، مردم گرم.',
      rule: { sell: 1.12, tierCost: 1.25 },
      ruleNote: 'مردم پای کارت می‌ایستند، ولی ساختن این‌جا گران است.'
    },
    {
      name: 'پایتخت', climate: 'mild', tint: '#241f2e', note: 'همه عجله دارند.',
      rule: { sell: 1.22, tierCost: 1.40, rival: .5 },
      ruleNote: 'بزرگ‌ترین بازار — ولی رقیب از قبل نصف کوچه را گرفته.'
    },
    {
      name: 'شهر مرزی', climate: 'desert', tint: '#2a2020', note: 'کامیون‌ها تمام شب می‌آیند.',
      rule: { sell: 1.06, space: 1, fine: 2 },
      ruleNote: 'شب‌ها شلوغ است، ولی بازرس این‌جا شوخی ندارد.'
    }
  ];
  ...
  /* ═══════════════════════════════════════════════
     ...
     هر غذا یک ساعت دارد و یک هوا. کله‌پاچه سحر می‌خواهد، فالوده
     گرما. تا این‌جا ساعت و هوا فقط عدد بودند؛ منو همان دو تا را به
     یک تصمیم تبدیل می‌کند: امشب چه می‌پزی.

     bands با نام بازه‌های تقاضا در DEMAND می‌خواند، wx با WEATHER.
     ═══════════════════════════════════════════════ */
  var MENU = [
    {
      id: 'ash', name: 'آش رشته', tier: 0, bands: ['late', 'peak'], wx: ['cold', 'snow', 'rain'],
      desc: 'دیگ بزرگ، شب سرد، صف کوتاه ولی همیشگی'
    },
    {
      id: 'adasi', name: 'عدسی', tier: 0, bands: ['morning', 'dead'], wx: ['cold', 'fog'],
      desc: 'صبحِ زود، دستِ کارگری که عجله دارد'
    },
    {
      id: 'kalepache', name: 'کله‌پاچه', tier: 1, bands: ['dead'], wx: ['cold', 'snow', 'fog'],
      desc: 'سحر. کسی که این را می‌خواهد، ساعتش با بقیه فرق دارد'
    },
    {
      id: 'jigar', name: 'جگرکی', tier: 2, bands: ['peak'], wx: ['clear', 'fog'],
      desc: 'بوی زغال تا سر کوچه می‌رود'
    },
    {
      id: 'kabab', name: 'کوبیده', tier: 3, bands: ['peak', 'lunch'], wx: ['clear', 'hot'],
      desc: 'همانی که آدم برایش از آن سر شهر می‌آید'
    },
    {
      id: 'dizi', name: 'دیزی', tier: 4, bands: ['lunch'], wx: ['cold', 'snow'],
      desc: 'ظهرِ جمعه، دو ساعت وقت گرفتن'
    },
    {
      id: 'haleem', name: 'حلیم', tier: 5, bands: ['morning', 'dead'], wx: ['cold', 'snow', 'fog'],
      desc: 'قبل از آفتاب تمام می‌شود'
    },
    {
      id: 'falafel', name: 'فلافل', tier: 6, bands: ['afternoon', 'peak'], wx: ['hot', 'clear'],
      desc: 'ارزان، تند، برای جیبِ دانشجو'
    },
    {
      id: 'faloode', name: 'فالوده', tier: 7, bands: ['afternoon', 'lunch'], wx: ['hot'],
      desc: 'تابستان که می‌شود، خودش می‌فروشد'
    }
  ];

  /* دستور پخت هر غذا — برای کارتِ فرستادنی.
     عمداً واقعی و کوتاه است: کارتی که فقط اسم غذا داشته باشد را کسی
     نگه نمی‌دارد، ولی دستوری که بشود باهاش آشپزی کرد، می‌ماند. */
  var RECIPES = {
    ash: {
      items: ['رشته‌ی آشی ۲۵۰ گرم', 'نخود و لوبیا، شب قبل خیس', 'سبزی آش یک کیلو',
        'پیازداغ فراوان', 'کشک و نعنا داغ'],
      how: 'حبوبات را بپز تا نرم شود، سبزی را اضافه کن و نیم‌ساعت بجوشان. رشته را آخر بریز که وا نرود. کشک را روی شعله‌ی خاموش بزن.'
    },
    adasi: {
      items: ['عدس ۳۰۰ گرم', 'پیاز درشت', 'سیر چهار حبه', 'زردچوبه و فلفل', 'آبلیمو'],
      how: 'عدس را با آب سرد بار بگذار. پیازداغ و سیر را آخر کار اضافه کن. باید غلیظ باشد نه آبکی — قاشق که می‌کشی، جایش بماند.'
    },
    kalepache: {
      items: ['کله و پاچه‌ی تمیزشده', 'پیاز و سیر', 'دارچین و لیمو عمانی', 'نمک درشت'],
      how: 'شب تا صبح روی شعله‌ی خیلی ملایم. کف رویش را مدام بگیر، وگرنه بوی زُهم می‌ماند. با دارچین و لیمو عمانی سبک می‌شود.'
    },
    jigar: {
      items: ['جگر و دل و قلوه', 'دنبه', 'نمک و فلفل', 'لیمو تازه'],
      how: 'روی زغالِ سرخ، نه شعله. بین هر تکه جگر یک تکه دنبه بزن. نمک را آخر بپاش — زودتر بزنی، آبش می‌رود.'
    },
    kabab: {
      items: ['گوشت چرخ‌کرده‌ی مخلوط ۱ کیلو', 'پیاز رنده و آب‌گرفته', 'نمک و فلفل',
        'یخ خرد (دو قاشق)'],
      how: 'گوشت و پیاز را بیست دقیقه ورز بده تا بچسبد. یخ را وسط ورز اضافه کن. یک ساعت در یخچال بماند، بعد به سیخ بکش.'
    },
    dizi: {
      items: ['گوشت گردن با استخوان', 'نخود و لوبیا سفید', 'سیب‌زمینی و گوجه',
        'لیمو عمانی', 'دنبه'],
      how: 'همه را با هم بار بگذار و سه ساعت آرام بجوشد. آبش را جدا بکش، بقیه را بکوب. کوبیده باید نرم باشد ولی رشته‌رشته.'
    },
    haleem: {
      items: ['گندم پوست‌کنده', 'گوشت ماهیچه', 'دارچین و شکر', 'کره'],
      how: 'گندم را شب قبل خیس کن. با گوشت بجوشان تا هر دو وا برود، بعد بکوب تا کِش بیاید. روی هر کاسه کره‌ی داغ.'
    },
    falafel: {
      items: ['نخود خیسیده (نه پخته)', 'گشنیز و جعفری', 'سیر و پیاز', 'زیره و گشنیز کوبیده'],
      how: 'نخودِ خامِ خیسیده را با سبزی چرخ کن. خمیر باید بچسبد؛ اگر نچسبید کمی آرد نخودچی. روغن باید داغ باشد وگرنه چرب می‌شود.'
    },
    faloode: {
      items: ['رشته‌ی فالوده', 'شکر و گلاب', 'آب‌لیمو تازه', 'یخ'],
      how: 'شربت را بجوشان و کاملاً سرد کن. رشته را با شربتِ سرد قاطی کن و در فریزر هم بزن، تا یخ‌زده ولی جدا بماند.'
    }
  };

  /* هر غذای درست سرِ ساعت درست چقدر می‌ارزد */
  var MENU_TUNE = {
    band: .10,      /* ساعتش خواند */
    weather: .06,   /* هوایش هم خواند */
    miss: -.05,     /* نه ساعت نه هوا — دیگِ بی‌مشتری روی اجاق */
    lo: .85, hi: 1.18
  };
  ...
  /* ═══════════════════════════════════════════════
     ...
     گران فروختن به‌تنهایی سود نیست — مشتری کم می‌شود. چیزی که
     گرانی را ممکن می‌کند «اصالت» است: هرچه بیشتر خودت باشی، مردم
     بیشتر پای قیمتت می‌ایستند. این عمدی است، چون محور بازی همین است.

     پله‌ی وسط (شماره‌ی ۲) دقیقاً خنثی است.
     ═══════════════════════════════════════════════ */
  var PRICE_STEPS = [
    { id: 0, name: 'خیلی ارزان', mul: 0.80, note: 'صف طولانی، جیب خالی' },
    { id: 1, name: 'ارزان', mul: 0.90, note: 'مشتری بیشتر، حاشیه‌ی کمتر' },
    { id: 2, name: 'عادی', mul: 1.00, note: 'همان قیمت همیشگی' },
    { id: 3, name: 'گران', mul: 1.15, note: 'اگر آبرو داشته باشی، می‌ماند' },
    { id: 4, name: 'خیلی گران', mul: 1.30, note: 'فقط با اصالت بالا جواب می‌دهد' }
  ];
  /* حساسیت مشتری به قیمت. اصالتِ بالا تا ۵۵٪ از این حساسیت کم می‌کند. */
  var PRICE_TUNE = { k: 1.15, integShield: .55, floor: .3 };

  /* ═══════════════════════════════════════════════
     مشتری‌های همیشگی

     سرِ ساعت خودشان می‌آیند و فقط اگر غذاشان روی منو باشد.
     tip بر حسب «چند ثانیه درآمد» است، نه عدد ثابت — وگرنه در
     پرده‌های آخر به چشم نمی‌آید و در پرده‌ی اول بازی را می‌شکند.
     ═══════════════════════════════════════════════ */
  var REGULARS = [
    { id: 'nane', name: 'ننه‌ی همسایه', hour: 22, dish: 'ash', tip: 22, p: { nane: 3 }, line: 'مثل هر شب، سرِ همان ساعت.' },
    { id: 'shabkar', name: 'راننده‌ی شب', hour: 3, dish: 'kalepache', tip: 26, p: {}, line: 'ماشین را دمِ در نگه می‌دارد و می‌گوید «یکی، تند».' },
    { id: 'kargar', name: 'کارگر صبح', hour: 6, dish: 'adasi', tip: 18, p: {}, line: 'قبل از آفتاب می‌آید. پول خرد شمرده دستش است.' },
    { id: 'daneshjoo', name: 'دانشجو', hour: 14, dish: 'falafel', tip: 16, p: {}, line: 'با دو نفر دیگر می‌آید. همیشه یکی پول ندارد.' },
    { id: 'jomee', name: 'خانواده‌ی جمعه', hour: 20, dish: 'kabab', tip: 34, p: {}, line: 'چهار نفری. بچه‌ها روی پیشخوان دست می‌کشند.' },
    { id: 'bazres', name: 'بازرس', hour: 12, dish: 'dizi', tip: 20, p: { bazres: 4 }, line: 'این‌بار برگه دستش نیست. فقط ناهار.' }
  ];
  ...
  /* ═══════════════════════════════════════════════
     ...
     ═══════════════════════════════════════════════ */
  var RIVAL = {
    fromTier: 3,      /* قبل از این، رقیب هنوز جدی نیست */
    perDay: .55,      /* رشد روزانه */
    perTier: 1.2,
    full: 40,         /* این عدد یعنی نوارش پر است */
    bite: .10,        /* حداکثر گازی که از فروش می‌گیرد */
    cheapRelief: .5   /* اگر ارزان‌تر از او بفروشی، نصف می‌شود */
  };
  var LICENCE = {
    costShare: .04,   /* از هزینه‌ی پرده‌ی فعلی */
    days: 12,         /* چند روزِ بازی اعتبار دارد */
    every: 4,         /* هر چند روز یک بازرسی */
    fine: 90,         /* جریمه بر حسب ثانیه‌ی درآمد */
    dirtyInteg: 40    /* زیر این اصالت، جریمه دو برابر */
  };
  ...
  var GOALS = [
    ...
    { type: 'earn', n: [40, 70], t: 120, txt: function (n, need) { return 'تا دو دقیقه ' + A.util.money(need) + ' ایر جمع کن'; } },
    { type: 'earn', n: [90, 140], t: 180, txt: function (n, need) { return 'قسط این ماه: ' + A.util.money(need) + ' ایر'; } }
  ];

  /* ═══════════════════════════════════════════════
     نشان ارزها

     تا امروز هر سه ارز آیکن قرضی داشتند: دایره‌ی ساده، فیروزهِ عمومیِ قرضی،
     ستاره. حالا هرکدام شکل خودش را دارد و همه‌جا از همین‌جا می‌آید،
     تا اگر عوض شد، یک‌جا عوض شود.

     همه با viewBox 0 0 24 24 و همان قرارداد stroke بقیه‌ی آیکن‌ها.
     ═══════════════════════════════════════════════ */
  var MARK = {
    /* ایر — سکه، با چرخ دستی روی رویه‌اش */
    air: '<circle cx="12" cy="12" r="9"/>' +
      '<circle cx="9.4" cy="15" r="1.5"/><circle cx="15" cy="15" r="1.5"/>' +
      '<path d="M7.4 15h-.9V11h10.2l-.8 4h-1.4M10.9 15h2.6"/>' +
      '<path d="M8.6 11V9.4h6.2V11"/>',
    /* فیروزه — سنگ شش‌ضلعی با رگه */
    gem: '<path d="M8 3h8l4 6.6-8 11.4-8-11.4z"/>' +
      '<path d="M4.6 9.6h14.8"/><path d="M8 3l1.6 6.6L12 21M16 3l-1.6 6.6L12 21"/>',
    /* آبرو — دفترچه‌ی بسته با روبان */
    abroo: '<path d="M5 3.5h11a2 2 0 0 1 2 2v15H7a2 2 0 0 1-2-2z"/>' +
      '<path d="M5 17.5h13"/>' +
      '<path d="M11 3.5v7l2-1.6 2 1.6v-7"/>'
  };

  /* ═══════════════════════════════════════════════
     مینی‌گیم‌ها

     قانون سفت: هیچ‌کدام نباید منبع اصلی درآمد شوند. برای همین
     جایزه‌شان بر حسب «چند ثانیه درآمدِ خودت» است و سقف روزانه دارد.
     جمع بیشینه‌ی هر روز حدود شش دقیقه درآمد است — در برابر دورِ
     ۵۸ ساعته هیچ.

     kind تعیین می‌کند کدام موتور بازی اجرا شود (js/mini.js).
     ═══════════════════════════════════════════════ */
  var MINIS = [
    {
      id: 'bargain', name: 'چانه‌زنی', kind: 'bar', minTier: 0, perDay: 3, secs: 30,
      desc: 'فروشنده‌ی مواد قیمت گفته. نشانگر را وسط نگه دار.',
      hint: 'هرچه به وسط نزدیک‌تر، جنس ارزان‌تر',
      icon: '<path d="M12 3v18M8 7h6a3 3 0 0 1 0 6H9a3 3 0 0 0 0 6h7"/>'
    },
    {
      id: 'skewer', name: 'سیخ‌گردانی', kind: 'beat', minTier: 1, perDay: 3, secs: 26,
      desc: 'شش سیخ روی زغال. سرِ وقت بچرخانشان.',
      hint: 'زود بزنی خام می‌ماند، دیر بزنی می‌سوزد',
      icon: '<path d="M4 6h16M4 12h16M4 18h16"/><path d="M7 4v16M17 4v16"/>'
    },
    {
      id: 'queue', name: 'صف شلوغ', kind: 'match', minTier: 2, perDay: 2, secs: 28,
      desc: 'پنج نفر پشت هم سفارش می‌دهند. اشتباه ندهی.',
      hint: 'هر سفارش دو ثانیه‌ونیم وقت دارد',
      icon: '<circle cx="7" cy="7" r="2.4"/><circle cx="13" cy="7" r="2.4"/><circle cx="19" cy="7" r="2.4"/><path d="M3 20c0-3 2-4.6 4-4.6M9 20c0-3 2-4.6 4-4.6M15 20c0-3 2-4.6 4-4.6"/>',
      /* گزینه‌ها از خود منو می‌آیند، پس هرچه منو بازتر، سخت‌تر */
      rounds: 5
    },
    {
      id: 'safe', name: 'گاوصندوق شب', kind: 'dial', minTier: 3, perDay: 1, secs: 24,
      desc: 'سه بار رمز. آخر شب، پول را بگذار داخل.',
      hint: 'روزی یک‌بار — با فیروزه',
      icon: '<path d="M4 4h16v16H4z"/><circle cx="12" cy="12" r="4.4"/><path d="M12 7.6V12l3 1.6"/>',
      gem: 1
    }
  ];
  /* جایزه: چند ثانیه درآمد، ضرب در نمره‌ی صفر تا یک */
  var MINI_PAY = {
    bargain: 90, skewer: 70, queue: 110, safe: 150,
    floor: .15,      /* حتی بازیِ بد یک چیزی می‌دهد */
    minMoney: 400    /* در پرده‌ی اول که نرخ ناچیز است، دست خالی برنگردد */
  };
  ...
  var BOOK = [
    ...
    },
    {
      ...
      desc: function (l) { return 'هر دور با ' + A.util.money(4e3 * Math.pow(12, l)) + ' ایر شروع کن'; },
  ...
  /* چیزهایی که با فیروزه خریده می‌شوند */
  var SHOP_ITEMS = [
    {
  ...
  A.data = {
    ...
    SUBPARTS: SUBPARTS, SUB_GATES: SUB_GATES, LAYOUTS: LAYOUTS, FLOORS: FLOORS,
    MENU: MENU, MENU_TUNE: MENU_TUNE, RECIPES: RECIPES,
    PRICE_STEPS: PRICE_STEPS, PRICE_TUNE: PRICE_TUNE,
    REGULARS: REGULARS, RIVAL: RIVAL, LICENCE: LICENCE,
    MINIS: MINIS, MINI_PAY: MINI_PAY,
    ...
    GEM_PACKS: GEM_PACKS, BUNDLES: BUNDLES, SHOP_ITEMS: SHOP_ITEMS, MARK: MARK,
