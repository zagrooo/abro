...
(function (A) {
  ...
  /* ───────── مواد و ریسک ───────── */
  var ING = {
    cheap: { out: 1.3, cost: .17, integ: -6, label: 'ارزان', note: 'سریع‌تر، ولی مشتری قدیمی می‌فهمد' },
    normal: { out: 1, cost: .25, integ: -1, label: 'معمولی', note: 'همان همیشگی' },
    premium: { out: .87, cost: .34, integ: 5, label: 'ممتاز', note: 'کمتر می‌فروشی، بیشتر می‌مانند' }
  };
  var RISK = {
